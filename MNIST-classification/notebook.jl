...
# ╔═╡ b93186c6-8879-4e71-831f-fcc6b640a856
begin
	using MLDatasets
...
# ╔═╡ 9486548b-ba7a-4acb-8580-be81fccc709b
md"# Classifying digits in MNIST"

# ╔═╡ 97a7e175-5263-472b-ac72-6865046af89d
begin
	# complete_MNIST = MNIST(dir = joinpath(dirname(@__FILE__), "data"))
	MNIST(split=:train)
end

# ╔═╡ b3285ab0-bf3d-11ed-055d-3bb09969bd30
MNIST(split=:test)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "e689f628516f3343d010ee5c48b5e77422ebf3aa"
